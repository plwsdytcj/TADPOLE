...
writetable(B, 'after_impute.csv', 'WriteRowNames', true);

B = cell2table(C(1:end, :), 'VariableNames', t);
writetable(B, 'after_impute_and_selectCopy.csv', 'WriteRowNames', true);
